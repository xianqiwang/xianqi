...
public class DirectorySample extends SampleParentActivity {
    ...
    private com.loopj.android.http.FileAsyncHttpResponseHandler lastResponseHandler = null;
    private android.widget.CheckBox cbAppend, cbRename;
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        android.widget.Button deleteTargetFile = new android.widget.Button(this);
        deleteTargetFile.setText(R.string.button_delete_target_file);
        deleteTargetFile.setOnClickListener(new android.view.View.OnClickListener() {
            @Override
            public void onClick(android.view.View v) {
                clearOutputs();
                if (lastResponseHandler != null) {
                    java.io.File toBeDeleted = lastResponseHandler.getTargetFile();
        ...
        cbAppend = new android.widget.CheckBox(this);
        cbAppend.setText("Constructor \"append\" is true?");
        cbAppend.setChecked(false);
        cbRename = new android.widget.CheckBox(this);
    ...
    public com.loopj.android.http.ResponseHandlerInterface getResponseHandler() {
        lastResponseHandler = new com.loopj.android.http.FileAsyncHttpResponseHandler(getCacheDir(), cbAppend.isChecked(), cbRename.isChecked()) {
            @Override
            public void onStart() {
                clearOutputs();
            }

...
/**
 * This sample demonstrates use of {@link com.loopj.android.http.RangeFileAsyncHttpResponseHandler} to
 ...
 */
public class RangeResponseSample extends com.loopj.android.http.sample.GetSample {
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        try {
            ...
            file = java.io.File.createTempFile("temp_", "_handled", getCacheDir());
        } catch (java.io.IOException e) {
            android.util.Log.e(LOG_TAG, "Cannot create temporary file", e);
        }
    }
    ...
    protected void onDestroy() {
        ...
        if (file != null) {
            if (!file.delete()) {
                android.util.Log.e(LOG_TAG, String.format("Couldn't remove temporary file in path: %s", file.getAbsolutePath()));
            }
            file = null;
        }
    }
    ...
    public com.loopj.android.http.ResponseHandlerInterface getResponseHandler() {
        return new com.loopj.android.http.RangeFileAsyncHttpResponseHandler(file) {
                ...
                if (fileSize < 1) {
                    ...
                    if (!supportsRange || fileSize < 1) {
                        android.widget.Toast.makeText(
                                com.loopj.android.http.sample.RangeResponseSample.this,
            ...
            @Override
            public void onFailure(int statusCode, cz.msebera.android.httpclient.Header[] headers, Throwable e, java.io.File file) {
                debugHeaders(LOG_TAG, headers);
                debugStatusCode(LOG_TAG, statusCode);
            ...
            void debugFileResponse(java.io.File file) {

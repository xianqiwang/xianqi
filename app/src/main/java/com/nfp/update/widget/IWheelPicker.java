...
import com.nfp.update.WheelPicker.OnWheelChangeListener;
...
public interface IWheelPicker {
     ...
     * 设置滚轮Item选中监听器
     *
     * @param listener 滚轮Item选中监听器{@link com.nfp.update.WheelPicker.OnItemSelectedListener}
     */
    ...
    /**
     * 设置滚轮选择器数据项的对齐方式
     * 默认对齐方式为居中对齐{@link com.nfp.update.WheelPicker#ALIGN_CENTER}
     * <p>
     * Set alignment of WheelPicker
     * The default alignment of WheelPicker is {@link com.nfp.update.WheelPicker#ALIGN_CENTER}
     *
     * @param align 对齐方式标识值
     *              该值仅能是下列值之一：
     *              {@link com.nfp.update.WheelPicker#ALIGN_CENTER}
     *              {@link com.nfp.update.WheelPicker#ALIGN_LEFT}
     *              {@link com.nfp.update.WheelPicker#ALIGN_RIGHT}
     */

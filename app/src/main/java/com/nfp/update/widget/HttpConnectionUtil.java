...
import com.nfp.update.SSLSocketFactoryCompat;
...
public class HttpConnectionUtil {
    ...
    private javax.net.ssl.HttpsURLConnection conn_https = null;
    ...
    public  String postDataToServer(String linkurl, String data) {
        ...
        try {
            ...
            android.util.Log.e(TAG, "postDataToServer(),linkurl : " + linkurl);
			android.util.Log.e(TAG, "postDataToServer(),data : " + data);
//			private HttpURLConnection conn_http = null;
//			private HttpsURLConnection conn_https = null;

            if(!linkurl.startsWith("https")) {
                conn_http = (java.net.HttpURLConnection) url.openConnection();
                //application/json
...
//				reader = new BufferedReader(inreader);
				...
				android.util.Log.i(TAG, "postDataToServer(),trescode=" + trescode);
				android.util.Log.i(TAG, "closeAllConnect(),10,end");
            }
            else {

                conn_https = (javax.net.ssl.HttpsURLConnection) url.openConnection();
                //application/json
...
//				conn_http.setRequestProperty("content-type","application/json");
                ...
                final javax.net.ssl.X509TrustManager trustAllCert =
...
//                                                    return new java.security.cert.X509Certificate[]{};
                ...
                final javax.net.ssl.SSLSocketFactory sslSocketFactory = new SSLSocketFactoryCompat (trustAllCert);
...
//				reader = new BufferedReader(inreader);
            ...
            android.util.Log.e(TAG, "postDataToServer(),trescode=" + trescode);
            if(200==trescode) {
                ...
                android.util.Log.i(TAG,"startWDataThread(),tdata="+tdata);
    ...
    private void closeAllConnect() {
        android.util.Log.i(TAG, "closeAllConnect(),1,start");
        try {
            if(null!=conn_http) {
...
//		}
        ...
        android.util.Log.i(TAG, "closeAllConnect(),1,end");
    }
}

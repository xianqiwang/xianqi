...
public abstract class MyAdapter<T> extends android.widget.BaseAdapter {
    ...
    public static class ViewHolder {
         ...
         * 设置点击监听
         */
        public com.nfp.update.MyAdapter.ViewHolder setOnClickListener(int id, android.view.View.OnClickListener listener) {
         ...
         * 设置可见
         */
        public com.nfp.update.MyAdapter.ViewHolder setVisibility(int id, int visible) {
         ...
         * 设置标签
         */
        public com.nfp.update.MyAdapter.ViewHolder setTag(int id, Object obj) {

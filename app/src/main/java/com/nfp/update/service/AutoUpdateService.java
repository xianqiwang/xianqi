...
package com.nfp.update.service;
...
import com.nfp.update.LowBatteryActivity;
import com.nfp.update.PropertyUtils;
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())){
                ...
                if(curLevel<30){
                  ...
                  UpdateUtil.insertEventLog(context,0, getString(R.string.install_result), 0, getString(R.string.fail), getString(R.string.no_enough_battery), null);
                }else{

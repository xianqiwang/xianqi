...
public class ProgressBarWithPercent extends android.view.View {
	...
	private final int default_text_color = android.graphics.Color.rgb(66, 145, 241);
	private final int default_reached_color = android.graphics.Color.rgb(66, 145, 241);
	private final int default_unreached_color = android.graphics.Color.rgb(204, 204, 204);
	 ...
	 */
	private android.graphics.Paint mReachedBarPaint;
	/**
	 * The Paint of the unreached area.
	 */
	private android.graphics.Paint mUnreachedBarPaint;
	/**
	 ...
	 */
	private android.graphics.RectF mUnreachedRectF = new android.graphics.RectF(0, 0, 0, 0);
	/**
	 * Reached bar area rect.
	 */
	private android.graphics.RectF mReachedRectF = new android.graphics.RectF(0, 0, 0, 0);
	...
	public ProgressBarWithPercent(android.content.Context context) {
		this(context, null);
	}

	public ProgressBarWithPercent(android.content.Context context, android.util.AttributeSet attrs) {
	...
	public ProgressBarWithPercent(android.content.Context context, android.util.AttributeSet attrs,
		...
		final android.content.res.TypedArray attributes = context.getTheme()
	...
	private void initializePainters() {
		mReachedBarPaint = new android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG);
		mReachedBarPaint.setColor(mReachedBarColor);

		mUnreachedBarPaint = new android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG);
		mUnreachedBarPaint.setColor(mUnreachedBarColor);

		mTextPaint = new android.graphics.Paint(android.graphics.Paint.ANTI_ALIAS_FLAG);
	...
	protected void onRestoreInstanceState(android.os.Parcelable state) {
		if (state instanceof android.os.Bundle) {
			...
			setProgressTextVisibility(bundle
					.getBoolean(INSTANCE_TEXT_VISIBILITY) ? com.nfp.update.ProgressBarWithPercent.ProgressTextVisibility.Visible
					: com.nfp.update.ProgressBarWithPercent.ProgressTextVisibility.Invisible);
	...
	public void setProgressTextVisibility(com.nfp.update.ProgressBarWithPercent.ProgressTextVisibility visibility) {
		mIfDrawText = visibility == com.nfp.update.ProgressBarWithPercent.ProgressTextVisibility.Visible;
		invalidate();
	}
